...
# Gitopia Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Gitopia için `utlore` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Gitopia için `gitopia`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **Gitopia**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
| **grpc_port** | "app.toml" dosyasında tanımlanan doğrulayıcı "grpc" bağlantı noktanız. Varsayılan değer `11090`dır |
| **rpc_port** | "config.toml" dosyasında tanımlanan doğrulayıcı "rpc" bağlantı noktanız. Varsayılan değer `11657`dir |
