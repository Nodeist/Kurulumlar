...
# Kujira Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| **grpc_port** | "app.toml" dosyasında tanımlanan doğrulayıcı "grpc" bağlantı noktanız. Varsayılan değer `34090`dır |
| **rpc_port** | "config.toml" dosyasında tanımlanan doğrulayıcı "rpc" bağlantı noktanız. Varsayılan değer `34657`dir |
...
> Örneğin: ```$HOME/Nodeistor/ag_ekle.sh 1.2.3.4 Kujiravaloper1s9rtstp8amx9vgsekhf3rk4rdr7qvg8dlxuy8v Kujira1s9rtstp8amx9vgsekhf3rk4rdr7qvg8d6jg3tl Kujira```
