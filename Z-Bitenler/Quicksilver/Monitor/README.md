...
# Quicksilver Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Quicksilver için `uqck` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Quicksilver için `quick`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **quick**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
...
** Eğer node kurulumunu bizim dökümanımızdan yaptıysanız, Kurulumlar sayfamızdan Quicksilver port adresini kontrol edebilirsiniz. **

![nodeist](https://i.hizliresim.com/8nedatw.png)

Bu örnekte resimde gördüğünüz gibi Quicksilver portumuz `36`.

Bunun anlamı şudur: Sizin default hali `9090` olan `adresport` unuz eğer node kurulumunu bizim dökümanımızdan yaptıysanız `36090`dır.

Aynı şekilde default hali `266657` olan `ladrport` unuz ise `36657`dir.
...
> Örneğin: ```$HOME/Nodeistor/ag_ekle.sh 1.2.3.4 Quicksilvervaloper1s9rtstp8amx9vgsekhf3rk4rdr7qvg8dlxuy8v Quicksilver1s9rtstp8amx9vgsekhf3rk4rdr7qvg8d6jg3tl Quicksilver```
