...
** If you have installed the node from our document, you can check Uptick port address on our Installations page. **

![nodeist](https://i.hizliresim.com/8nedatw.png)

In this example, as you can see in the picture, our Uptick port is `40`.

This means: Your 'address', which is '9090' by default, is '40090' if you have installed the node from our document.

Likewise, your 'ladrport' which defaults to '26657' is '40657'.
