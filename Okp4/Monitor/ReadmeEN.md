...
# Okp4 Grafana Monitor Installation Guide
## Prerequisites
...
| KEY |VALUE |
|----------|-------------|
| **bond_denom** | Denom Value. For example `uknow` for Okp4 |
| **bench_prefix** | Bench Prefix Value. For example `okp4` for Okp4. You can learn this value from your wallet address. **okp4**jcqum902je9zwevat7zqczskwd4lhwuj9vwgsu |
