...
# Okp4 Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Okp4 için `uknow` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Okp4 için `celestia`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **Okp4**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
