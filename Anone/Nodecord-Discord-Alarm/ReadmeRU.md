...
- RPC: вы можете легко найти подключение RPC от компаний, которые предлагают услугу RPC. Обычно я следую за Полкачу.
Пример RPC для Kujira: **https://kujira-rpc.polkachu.com/**
