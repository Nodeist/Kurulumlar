...
# Hypersign Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Hypersign için `uhid` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Hypersign için `hid`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **hid**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
