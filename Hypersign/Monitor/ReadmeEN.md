...
# Hypersign Grafana Monitor Installation Guide
## Prerequisites
...
| KEY |VALUE |
|----------|-------------|
| **bond_denom** | Denom Value. For example `uhid` for Hypersign |
| **bench_prefix** | Bench Prefix Value. For example `hid` for Hypersign. You can learn this value from your wallet address. **hid**jcqum902je9zwevat7zqczskwd4lhwuj9vwgsu |
