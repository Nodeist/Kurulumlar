...
# SGE Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin SGE için `usge` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin SGE için `celestia`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **SGE**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
| **grpc_port** | "app.toml" dosyasında tanımlanan doğrulayıcı "grpc" bağlantı noktanız. Varsayılan değer `51090`dır |
| **rpc_port** | "config.toml" dosyasında tanımlanan doğrulayıcı "rpc" bağlantı noktanız. Varsayılan değer `51657`dir |
