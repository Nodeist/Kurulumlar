...
# Ollo Grafana Monitor Installation Guide
## Prerequisites
...
| KEY |VALUE |
|----------|-------------|
| **bond_denom** | Denom Value. For example `utollo` for Ollo |
| **bench_prefix** | Bench Prefix Value. For example `celestia` for Ollo. You can learn this value from your wallet address. **ollo**jcqum902je9zwevat7zqczskwd4lhwuj9vwgsu |
