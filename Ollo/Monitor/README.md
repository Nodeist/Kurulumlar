...
# Ollo Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Ollo için `utollo` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Ollo için `ollo`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **Ollo**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
