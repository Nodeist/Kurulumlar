...
# Clan Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Clan için `uclan` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Clan için `Clan`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **Clan**jcqum902je9zwevat7zqczskwd4lhwuj9vwgsu |
...
Bunun anlamı şudur: Sizin default hali `9090` olan `adresport` unuz eğer node kurulumunu bizim dökümanımızdan yaptıysanız `31090`dır.

Aynı şekilde default hali `266657` olan `ladrport` unuz ise `31657`dir.
