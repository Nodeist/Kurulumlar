...
# Terp Grafana Monitor Installation Guide
## Prerequisites
...
| KEY |VALUE |
|----------|-------------|
| **bond_denom** | Denom Value. For example `uterpx` for Terp |
| **bench_prefix** | Bench Prefix Value. For example `terp` for Terp. You can learn this value from your wallet address. **terp**jcqum902je9zwevat7zqczskwd4lhwuj9vwgsu |
