...
# Terp Grafana Monitor Kurulum Rehberi
## Önkoşullar
...
| ANAHTAR |DEĞER |
|---------------|-------------|
| **bond_denom** | Denom Degeri. Örneğin Terp için `uterpx` |
| **bench_prefix** | Bench Prefix Değeri. Örneğin Terp için `terp`. Bu değeri cüzdan adresinizden öğrenebilirsiniz. **Terp**1r5g0kes6jutsydez9qw2tx6vuc8scpxn5qtyle |
