...
```bash
gitopiad tx slashing unjail --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```
...
```bash
gitopiad tx staking delegate $(gitopiad keys show wallet --bech val -a) 1000000ulore --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```

#### Delegate tokens to validator

```bash
gitopiad tx staking delegate <TO_VALOPER_ADDRESS> 1000000ulore --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```

#### Redelegate tokens to another validator

```bash
gitopiad tx staking redelegate $(gitopiad keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000ulore --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```

#### Unbond tokens from your validator

```bash
gitopiad tx staking unbond $(gitopiad keys show wallet --bech val -a) 1000000ulore --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```

#### Send tokens to the wallet

```bash
gitopiad tx bank send wallet <TO_WALLET_ADDRESS> 1000000ulore --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```
...
```bash
gitopiad tx gov vote 1 no --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```

#### Vote 'Abstain'

```bash
gitopiad tx gov vote 1 abstain --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```

#### Vote 'NoWithVeto'

```bash
gitopiad tx gov vote 1 NoWithVeto --from wallet --chain-id gitopia --gas-adjustment 1.4 --gas auto --gas-prices 0.025ulore -y
```
...
```bash
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.025ulore\"/" $HOME/.gitopia/config/app.toml
```
