...
# CrowdControl Grafana Monitor Installation Guide
## Prerequisites
...
| KEY |VALUE |
|----------|-------------|
| **bond_denom** | Denom Value. For example `ubpf` for CrowdControl |
| **bench_prefix** | Bench Prefix Value. For example `cc` for CrowdControl. You can learn this value from your wallet address. **one1**jcqum902je9zwevat7zqczskwd4lhwuj9vwgsu |
| **adresport** | Address Port. Default is 9090. check on app.toml |
| **ladrport** | Laddr Port. The default is 26657. Check in config.toml. |

** If you have installed the node from our document, you can check CrowdControl port address on our Installations page. **

![nodeist](https://i.hizliresim.com/8nedatw.png)

In this example, as you can see in the picture, our CrowdControl port is `43`.

This means: Your 'address', which is '9090' by default, is '43090' if you have installed the node from our document.

Likewise, your 'ladrport' which defaults to '26657' is '43657'.
