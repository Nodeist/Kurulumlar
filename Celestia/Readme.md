...
```
wget -O Nodeistcelestia.sh https://raw.githubusercontent.com/Nodeist/Kurulumlar/main/Celestia/Nodeistcelestia.sh && chmod +x Nodeistcelestia.sh && ./Nodeistcelestia.sh
```
