...
echo "==================================================="
echo -e '\e[32mNode durumunu kontrol et\e[39m' && sleep 1
if [[ `service tidechaind status | grep active` =~ "running" ]]; then
  echo -e "Tidechain nodeunuz \e[32mbasariyla yuklendi\e[39m!"
else
  echo -e "Tidechain nodeunuz \e[31mhatalı yuklendi\e[39m, lutfen temiz sunucuya tekrar sıfır kurulum yapın."
fi
echo -e "Logl Kontrol: \e[32mjournalctl -fu tidechaind -o cat\e[39m"
sleep 2
