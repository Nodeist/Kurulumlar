...
** If you have installed the node from our document, you can check Deweb port address on our Installations page. **

![nodeist](https://i.hizliresim.com/8nedatw.png)

In this example, as you can see in the picture, our Deweb port is `33`.

This means: Your 'address', which is '9090' by default, is '33090' if you have installed the node from our document.

Likewise, your 'ladrport' which defaults to '26657' is '33657'.
