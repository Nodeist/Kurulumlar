...
```bash
andromedad tx slashing unjail --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```
...
```bash
andromedad tx staking delegate $(andromedad keys show wallet --bech val -a) 1000000uandr --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```

#### Delegate tokens to validator

```bash
andromedad tx staking delegate <TO_VALOPER_ADDRESS> 1000000uandr --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```

#### Redelegate tokens to another validator

```bash
andromedad tx staking redelegate $(andromedad keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000uandr --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```

#### Unbond tokens from your validator

```bash
andromedad tx staking unbond $(andromedad keys show wallet --bech val -a) 1000000uandr --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```

#### Send tokens to the wallet

```bash
andromedad tx bank send wallet <TO_WALLET_ADDRESS> 1000000uandr --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```
...
```bash
andromedad tx gov vote 1 no --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```

#### Vote 'Abstain'

```bash
andromedad tx gov vote 1 abstain --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```

#### Vote 'NoWithVeto'

```bash
andromedad tx gov vote 1 NoWithVeto --from wallet --chain-id galileo-3 --gas-adjustment 1.4 --gas auto --gas-prices 0.025uandr -y
```
...
```bash
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.025uandr\"/" $HOME/.andromedad/config/app.toml
```
